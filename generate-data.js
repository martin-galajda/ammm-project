...
const NUMBER_OF_TRUCKS = 3

const MIN_HEIGHT_TRUCK = 5
const MIN_WIDTH_TRUCK = 5

const MAX_HEIGHT_TRUCK = 15
const MAX_WIDTH_TRUCK = 15
...
const CHANCE_TO_GENERATE_PACKAGE = 0.5
...
fs.writeFileSync('generated-data.txt', output)
