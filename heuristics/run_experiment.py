...
def run_experiment(input_filename, alpha = 0.8, max_iterations = 1000, max_time_in_seconds = None):
  ...
  if max_time_in_seconds is None:
    ...
    best_solution, best_cost_solution, time_computing, iters = grasp(problem_cost_function, alpha, greedy_loss_function_2, max_iterations, data)
    ...
    best_solution, best_cost_solution, time_computing, iters = grasp_by_max_time(problem_cost_function, alpha, greedy_loss_function_2, max_time_in_seconds, data)
