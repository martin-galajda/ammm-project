...
def greedy_loss_function(input, solution, potential_element_solution, params = None):
  ...
  greedy_cost += number_of_possibilities_for_p * 10
...
default_greedy_loss_function_params = {
  ...
  'cost_for_size_of_package': 50,
  'cost_for_package_weight': -10,
  'cost_for_capacity_left': -30
}

def greedy_loss_function_2(input, solution, potential_element_solution, parameters = default_greedy_loss_function_params):
  p, t = potential_element_solution
  already_assigned_truck = np.any(solution["pt"][:,t] == 1)
